...
(function (global, factory) {
  ...
  (global.Cropper = factory());
                        ...
                        //prateek changed for internet explore 1/06/2017
...
var render$1 = {
  ...
  initContainer: function initContainer() {
    ...
    //    height: Math.max(container.offsetHeight, Number(options.minContainerHeight) || 100)
      //}; //-------------------prateek ,for adjusting the height width of the hidden image  30.05.2017
    ...
    if ($(container).is(':visible'))
    {
        ...
        self.containerData = containerData = {
            width: self.element.naturalWidth,
            height: self.element.naturalHeight 
        };
    }
  ...
  renderCanvas: function renderCanvas(changed) {
    ...
    if (self.canvas.className == 'cropper-canvas') {
        canvasData.left = 0;
      }
  ...
  renderCropBox: function renderCropBox() {
    ...
    if (self.cropBox.className == 'cropper-canvas') {
        cropBoxData.left = 0;
    }
...
var methods = {
  ...
  setCanvasData: function setCanvasData(data) {
    var self = this;
    var canvasData = self.canvasData;
    var aspectRatio = canvasData.aspectRatio || .75;
    ...
    if (self.ready && !self.disabled && isPlainObject(data)) {
      ...
      if (isNumber(data.width)) {
        ...
        canvasData.height = data.width / .75;
      } else if (isNumber(data.height)) {
        canvasData.height = data.height;
        canvasData.width = data.height * .75;
      }
  ...
  //      if (self.cropped) {                     //prateek not needed as of now hardcoded 3/4;
  //        self.renderCropBox();
  //      }
  //    }
  //  }
